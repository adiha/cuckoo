...
table = [
    ...
    ("SetWinEventHook", "system", ("llplll", "eventMin", "eventMax", "hmod", "ThreadId", "ProcessId", "Flags")),
    ...
    ("VirtualProtectEx", "process", ("ppppll", "ProcessHandle", "Address", "Size", "Protection", "ProcessId", "CurrentProcessId")),
    ...
    ("monitorCPU", "misc", ("")),
    ("monitorUnpacking", "misc", ("")),
    ("ZwLoadDriver", "misc", ("o", "DriverServiceName")),
    ("NtLoadDriver", "misc", ("o", "DriverServiceName")),
]
